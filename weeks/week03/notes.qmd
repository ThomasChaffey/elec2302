...
What do we have at time $4$?

$h$ started at $3$ and gone $1$ time step: $\;\overbrace{h(t-3)}^{h(1)}\,u(3)\;$

$h$ started at $2$ and gone $2$ time steps: $\;\overbrace{h(t-2)}^{h(2)}\,u(2)\;$

$h$ started at $1$ and gone $3$ time steps: $\;\overbrace{h(t-1)}^{h(3)}\,u(1)\;$
...
Example: plot $(p_1 * p_1)(t)$

$$ \int_{-\infty}^{\infty}\! p_1(t-\tau)\,p_1(\tau)\,\mathrm{d}\tau $$

The overlapping area is the value of $(p_1 * p_1)(t)$.
...
::: {.content-visible when-format="pdf"}
![Top: $p_1(\tau)$ fixed and the flipped copy $p_1(t-\tau)$ sliding across it, with the
overlap hatched. Bottom: the overlap area traced out as $t$ sweeps, giving the triangle
$(p_1 * p_1)(t)$. Shown at $t = 0.5$.](figs/w-conv.png){#fig-conv width=70%}
:::
...
<svg viewBox="0 0 540 200" width="520" xmlns="http://www.w3.org/2000/svg" role="img"
  ...
  <g stroke="#00468C" fill="none" stroke-width="1.2">
    ...
    <path d="M 318 100 A 20 20 0 0 0 318 68"/>
    <line x1="320" y1="95" x2="324" y2="86"/>
  </g>
  <g stroke="#00468C" fill="none" stroke-width="1.2">
    <line x1="322" y1="84" x2="470" y2="30"/>
    <line x1="322" y1="84" x2="480" y2="62"/>
    <line x1="322" y1="84" x2="472" y2="96"/>
  </g>
  <g fill="#00468C">
  ...
  <text x="390" y="107" font-family="Arial" font-size="13" fill="#00468C" font-style="italic">r&#8323;</text>
</svg>
</div>
```
...
Intuitively: $u(t) = \cos(\omega t)$, $\;y(t) = \sum_i \cos(\omega t + t_{d_i}).$
...
y(t) &= u(t) * h(t) \\[2pt]
     ...
     &= \sum_i \cos(\omega t + t_{d_i}).
\end{aligned}
$$

<!-- CHECK: the last line is transcribed as written. Substituting u(t) = cos(wt) into
     u(t - t_di) gives cos(w(t - t_di)) = cos(wt - w t_di), not cos(wt + t_di). The same
     applies to the "intuitively" line above. -->
