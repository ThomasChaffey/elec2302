...
subtitle: "Transfer functions, Bode diagrams and resonance"
---
...
![Series RLC circuit, with the drop across each element marked (drawn with circuitikz).](circuit-rlc.svg){width=560}
:::
...
::: {.note}
<span class="out">Do hand example here?</span>
:::
...
::: {style="text-align:center"}
![Series RC circuit driven by $v(t)$ (drawn with circuitikz).](circuit-rc.svg){width=380}
:::
...
::: {.note}
<span class="out">$K$, then assumed $1$.</span>
:::
